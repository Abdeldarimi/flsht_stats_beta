...
$total_masculins = $pdo->query("SELECT COUNT(*) FROM etudiants where Sexe = 'M' ")->fetchColumn();
// $percentage_masculins = ($total_masculins / $total_etudiants) * 100;
include 'header.php';
...
?>
 ...
 <div class=" grid grid-cols-1 md:grid-cols-3 gap-6"">
    ...
    <!-- <div class="bg-white shadow rounded p-6 flex flex-col items-center">
        <div class="text-gray-500 mb-2">Masculin</div>
        <div class="relative w-24 h-24">
            <circle cx="50%" cy="50%" r="40%" stroke="#f63b3bff" stroke-width="8" fill="none" 
    stroke-dasharray="251.2" 
    stroke-dashoffset="<?php echo 251.2 * (1 - $percentage_masculins / 100); ?>" 
    stroke-linecap="round"/>
<div class="absolute inset-0 flex items-center justify-center text-blue-600 font-bold">
    <?php echo round($percentage_masculins); ?>%
</div> -->
