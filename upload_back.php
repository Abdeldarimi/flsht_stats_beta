...
<div class="mb-1">
    <a href="upload.php?mode=etudiants" class="px-2 py-1 rounded hover:text-blue-500 <?= $mode==='etudiants'?'bg-blue-50':'' ?>">رفع طلاب</a>
    <a href="upload.php?mode=etudiant_diplomé" class="px-2 py-1 rounded hover:text-blue-500 <?= $mode==='etudiant_diplomé'?'bg-blue-50':'' ?>">رفع طلاب diplome</a>
    <a href="upload.php?mode=notes" class="px-2 py-1 rounded hover:text-blue-500 <?= $mode==='notes'?'bg-blue-50':'' ?>">رفع نقاط</a>
</div>
...
<form method="post" enctype="multipart/form-data" class="p-2 border rounded bg-white">
    <div class="mb-1">
